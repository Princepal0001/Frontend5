    ...
    return ( 
        ...
        <div className="row p-5 mt-5 mb-5">
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            ...
            <br />
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
              Finexa IDFC FIRST Bank 3-in-1 Account
            </a>
            <br />
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
              Getting Started
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            <h4 className="">
              <i class="fa fa-plus-circle" aria-hidden="true"></i> Your Finexa Account
            </h4>
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
             Login Credentials
            </a>
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            ...
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
              margin/leverage, Product and Orders
            </a>
            <br />
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
              Kite Web and Mobile
